...
git commit -m "STARTED contribution with Googlers"
...
git remote set-url origin https://github.com/sakib-rahman-bangladesh/hello-beacons
...
git push --all -f https://github.com/sakib-rahman-bangladesh/hello-beacons